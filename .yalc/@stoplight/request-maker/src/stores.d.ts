...
declare class RequestStore {
    ...
    timeout: number;
    uri: string;
    readonly prismRequest: import("@stoplight/prism-http/lib/types").IHttpRequest;
    setParam<T extends keyof IParam>(type: ParamType, index: string | number, prop: T, value: IParam[T]): void;
    addParam(type: ParamType, key?: string, value?: string): void;
    removeParam(type: ParamType, index: string | number): void;
