export declare const Classes: {
    ...
    alignmentClass(alignment: "center" | "left" | "right"): string;
    elevationClass(elevation: 0 | 1 | 2 | 4 | 3): string;
    iconClass(iconName?: string | undefined): string;
    intentClass(intent?: "none" | "primary" | "success" | "warning" | "danger" | undefined): string;
    positionClass(position: "left" | "right" | "bottom" | "bottom-left" | "bottom-right" | "left-bottom" | "left-top" | "right-bottom" | "right-top" | "top" | "top-left" | "top-right"): string;
    ACTIVE: string;
    ALIGN_LEFT: string;
    ALIGN_RIGHT: string;
    DARK: string;
