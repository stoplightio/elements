...
const CodeEditor = React.forwardRef((props, ref) => {
    ...
    return (React.createElement(react_simple_code_editor_1.default, Object.assign({}, rest, { ref: ref, className: cn(className, 'bp3-code-editor'), style: style, placeholder: placeholder, autoFocus: autoFocus, value: value, onValueChange: onChange, highlight: highlight, padding: padding })));
});
