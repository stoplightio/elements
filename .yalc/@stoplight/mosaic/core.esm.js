...
import cn from 'clsx';
import React__default, { forwardRef, memo, useRef, useImperativeHandle, useMemo, useState, useCallback, useEffect, useContext, createElement, useLayoutEffect, createContext } from 'react';
import { findIconDefinition, library } from '@fortawesome/fontawesome-svg-core';
import { faCaretDown, faCaretLeft, faCaretRight, faCaretUp, faCheck, faChevronDown, faChevronLeft, faChevronRight, faChevronUp, faCopy, faExclamationCircle, faExclamationTriangle, faExpandArrowsAlt, faExternalLinkAlt, faInfoCircle, faLink, faSort } from '@fortawesome/free-solid-svg-icons';
...
import { FocusRing, FocusScope, useFocusRing, focusSafely, getFocusableTreeWalker, FocusableProvider } from '@react-aria/focus';
import { useHover, usePress, useMove, Pressable, PressResponder, useFocus, useInteractionModality } from '@react-aria/interactions';
...
import { Item as Item$1, useCollection } from '@react-stately/collections';
import { useListState, useSingleSelectListState, ListCollection } from '@react-stately/list';
...
const layoutProps = props => {
  const {
    ...
    objectPosition
        ...
        rest = __rest(props, ["display", "overflowX", "overflowY", "objectFit", "objectPosition"]);
...
const transformProps = props => {
  const {
    ...
    translateY
        ...
        rest = __rest(props, ["transform", "transition", "transitionDelay", "transitionDuration", "translateX", "translateY"]);
...
const Box = forwardRef(function Box(_a, ref) {
  var {
    as,
    className,
    role,
...
const Container = memo(forwardRef(function Container(_a, ref) {
  var {
    size = 'full',
    className,
    style = {}
...
const Article = memo(function Article(_a) {
  var {
    className,
    children
  } = _a,
...
function AspectRatio(_a) {
  var {
    ...
    style = {}
      ...
      props = __rest(_a, ["ratio", "className", "children", "style"]); // enforce single child
...
const Flex = memo(forwardRef((_a, ref) => {
  var {
    align,
    justify,
    wrap,
...
const Icon = memo(function Icon(_a) {
  var {
    className,
    icon
  } = _a,
...
const Text = memo(forwardRef((_a, ref) => {
  var {
    size
  } = _a,
...
const Avatar = memo(forwardRef(function Avatar(props, ref) {
...
const WithDomRef = forwardRef(function WithDomRef({
  children
}, ref) {
...
const Badge = React__default.memo(forwardRef(function Input(_a, ref) {
  var {
    appearance = 'solid',
    size = 'sm',
    as = defaultElement$3,
    ...
    children
      ...
      props = __rest(_a, ["appearance", "size", "as", "className", "intent", "icon", "iconRight", "children"]);
...
const Button = memo(forwardRef((_a, ref) => {
  var {
    appearance = 'default',
    intent = 'default',
    size = 'md',
  ...
  const _c = mergeProps(matchedProps, buttonProps, hoverProps),
...
function useControllableState(props) {
  ...
  const {
    current: isControlled
  } = useRef(valueProp !== undefined); // don't switch from controlled to uncontrolled
...
const CopyButton = forwardRef((_a, ref) => {
  var {
    copyValue
  } = _a,
...
const FieldButton = forwardRef((_a, ref) => {
  var {
    children,
    placeholder,
    onClear
...
const Link = memo(forwardRef((_a, ref) => {
  var {
    className
  } = _a,
...
const MenuItem = forwardRef(function MenuItem(_a, ref) {
  var {
    text,
    indent,
    meta,
    ...
    iconColor
      ...
      props = __rest(_a, ["text", "indent", "meta", "checked", "onClick", "children", "href", "disabled", "__active", "__hasSubmenu", "icon", "iconColor"]);
...
const MenuRadioGroup = forwardRef(function MenuRadioGroup(_a, ref) {
  var {
    __menu,
    children,
    value,
...
const $Menu = memo(forwardRef(function Menu(_a, ref) {
  var {
    trigger,
    children,
    isSubmenu,
  ...
  const menu = useMenuState(menuStateOpts);
...
const MenuDivider = forwardRef((_props, ref) => {
  return React__default.createElement(Box, {
    ref: ref,
    tabIndex: -1,
    role: "separator",
...
const MenuOption = forwardRef(function MenuOption(props, ref) {
...
const ButtonGroup = memo(forwardRef((_a, ref) => {
  var {
    children,
    className
  } = _a,
...
const Heading = memo(function Heading(_a) {
  var {
    size
  } = _a,
...
const Stack = memo(forwardRef((_a, ref) => {
  var {
    className,
    spacing,
    direction = 'vertical',
...
const Callout = memo(function Callout(_a) {
  var {
    intent = 'default',
    appearance = 'default',
    heading,
    ...
    children
      ...
      props = __rest(_a, ["intent", "appearance", "heading", "className", "icon", "children"]);
...
const EntityName = memo(forwardRef(function EntityName(props, ref) {
  const {
    className,
    name,
    isHeading,
...
const ModalWrapper = _a => {
  ...
  const ref = useRef(); // Handle interacting outside the dialog and pressing
  ...
  const dialogPropsWithoutColor = __rest(dialogProps, ["color"]);

  const dialogTitlePropsWithoutColor = __rest(titleProps, ["color"]);
...
const ModalBox = forwardRef((_a, ref) => {
  var {
    isDraggable,
    moveProps = {},
    containerProps,
    ...
    size = 'md'
      ...
      props = __rest(_a, ["isDraggable", "moveProps", "containerProps", "dialogProps", "titleProps", "onClose", "children", "footer", "position", "isHidden", "isNotDismissable", "size"]);
...
const StaticModalBox = forwardRef((props, ref) => {
...
const DraggableModalBox = forwardRef((props, ref) => {
...
function ProductImage(_a) {
  ...
  var {
    ...
    bg = 'success'
      ...
      props = __rest(_a, ["className", "children", "focus", "caption", "bg"]);
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(Pressable, {
    onPress: open
  }, React__default.createElement(Box, Object.assign({
...
const Input = memo(forwardRef(function Input(_a, ref) {
  var {
    appearance = 'default',
    intent = 'default',
    size = 'md',
...
const LinkHeading = memo(function LinkHeading(_a) {
  var {
    id,
    children,
    className
...
function ListBoxBase(props, forwardRef) {
  ...
  return createElement(Box, Object.assign({}, listBoxProps, matchedProps, {
    color: matchedProps.color,
    ref: ref
  }), [...state.collection].map(item => createElement(ListBoxOption, {
    key: item.key,
    item: item,
    state: state
  })));
...
const ListBox = forwardRef(ListBoxBase);
...
function ListBoxOption({
  ...
  return createElement(Box, Object.assign({}, mergeProps(optionProps, focusProps), {
    bg: {
...
const Paragraph = memo(forwardRef((_a, ref) => {
  var {
    size = 'default'
  } = _a,
      restProps = __rest(_a, ["size"]);
...
const Popover = forwardRef((props, ref) => {
  ...
  const _triggerRef = useFocusableRef(useRef());
...
const PopoverWrapper = forwardRef((_a, ref) => {
  var {
    children,
    isOpen,
    onClose,
  ...
  let domRef = useDOMRef$1(ref); // Handle interacting outside the dialog and pressing
  // the Escape key to close the modal.
  ...
  const _b = mergeProps(overlayProps, dialogProps, otherProps, modalProps),
        containerProps = __rest(_b, ["color"]);
...
const Prose = memo(function Prose(_a) {
  var {
    className
  } = _a,
      props = __rest(_a, ["className"]);
...
function Select(_a) {
  ...
  const triggerRef = useFocusableRef(useRef());
  const onOpenChange = useCallback($isOpen => {
    if ($isOpen && onOpen) onOpen();
    if (!$isOpen && onClose) onClose();
  }, [onClose, onOpen]);
  const onSelection = useCallback(val => {
    if (onChange) {
  ...
  let keyCounter = 0;
  const children = useCallback(item => {
    keyCounter++;
...
const ListBoxPopup = forwardRef((_a, ref) => {
  var {
    state,
    minW,
    options
...
const Switch = memo(forwardRef((_a, ref) => {
  var {
    size = 'md',
    showIcon = false,
    className,
    ...
    onChange
      ...
      props = __rest(_a, ["size", "showIcon", "className", "isDisabled", "isSelected", "defaultSelected", "onChange"]);
...
function useTab(props, state, ref) {
  ...
  let {
    pressProps
  } = usePress(Object.assign(Object.assign({}, itemProps), {
    isDisabled
  }));
...
function useTabList(props, state, ref) {
  ...
  let delegate = useMemo(() => new TabsKeyboardDelegate(collection, direction, orientation, disabledKeys), [collection, disabledKeys, orientation, direction]);
  let {
    collectionProps
  ...
  let tabListLabelProps = useLabels(Object.assign(Object.assign({}, props), {
    id: tabsId
  }));
  return {
...
function TabImpl(props) {
  ...
  const _a = mergeProps(tabProps, hoverProps),
...
function useTabListState(props) {
  let state = useSingleSelectListState(Object.assign(Object.assign({}, props), {
    // @ts-ignore
...
function TabList(_a) {
  ...
  const tabListPropsWithoutColor = __rest(tabListProps, ["color"]);
...
const TabPanel = props => createElement(Item, Object.assign({}, props));
...
function TabPanels(_a) {
  ...
  const tabPanelPropsWithoutColor = __rest(tabPanelProps, ["color"]);
...
const Tooltip = props => {
  ...
  const focusableTriggerRef = useFocusableRef(props.triggerRef || _triggerRef); // should not need to call this, keep an eye on https://github.com/adobe/react-spectrum/issues/1175#issuecomment-712565101
...
const TooltipWrapper = forwardRef((_a, ref) => {
  var {
    children,
    state,
    style,
...
export { Article, AspectRatio, Avatar, Badge, Box, Button, ButtonGroup, Callout, Card, Code, Container, CopyButton, DEFAULT_THEME_MODE, Divider, EntityName, FieldButton, Flex, GLOBAL_CSS_ID, GLOBAL_CSS_THEME_ID, Grid, HStack, Heading, INIT_THEME_JS, Icon, Image, InitTheme, InlineStyles, Input, InvertTheme, InvertThemeContext, Link, LinkHeading, ListBox, ListBoxItem, MENU_ITEM_IDENT_WIDTH, Menu, MenuDivider, MenuItem, MenuOption, MenuRadioGroup, Modal, NoSsr, _Overlay as Overlay, Panel, Paragraph, Popover, ProductImage, Prose, Provider, Select, Stack, Switch, THEME_STORAGE_KEY, Tab, TabImpl, TabList, TabPanel, TabPanels, Tabs, Text, Tooltip, TreeItem, VStack, WithDomRef, __DEV__, accumulateCollectionKeysByProp, appendCss, borderPropNames, borderProps, colorPropNames, colorProps, computeTheme, containerSizes, defaultTheme, error, findCss, flexPropNames, flexProps, getContrastColor, getCssVariable, getResolvedThemeMode, injectStyles, interactivityPropNames, interactivityProps, isArray, isDefined, isEmpty, isEmptyArray, isEmptyObject, isFunction, isIconDefinition, isIconProp, isInputEvent, isNotEmptyObject, isNotNumber, isNull, isNumber, isNumeric, isObject, isString, isUndefined, layoutPropNames, layoutProps, marginProps, noop, once, paddingProps, parseHsl, positionPropNames, positionProps, prefersDarkMode, replaceCss, ringPropNames, ringProps, runIfFn, shadowPropNames, shadowProps, sizePropNames, sizeProps, spacingPropNames, splitBoxProps, splitProps, stringifyHsl, subscribeTheme, transformPropNames, transformProps, typographyPropNames, typographyProps, useClipboard, useCollectionKeyAccumulator, useControllableProp, useControllableState, useDOMRef, useIconStore, useModalState, useTheme, useThemeIsDark, useThemeMode, useThemeStore, useUnwrapDOMRef, warn };
