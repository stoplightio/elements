...
export declare const LinkHeading: React.NamedExoticComponent<HeadingOwnProps & {
    id?: string;
} & import("../..").ITypographyProps & import("../..").ISizeProps & import("../..").IMarginProps & import("../..").IPaddingProps & import("../..").IShadowProps & import("../..").IColorProps & import("../..").IBorderProps & import("../..").IRingProps & import("../..").IInteractivityProps & import("../..").IFlexProps & import("../..").IPositionProps & import("../..").TransformProps & import("../..").ILayoutProps & {
    as?: HeadingAs;
    className?: string;
    role?: string;
    noFocusRing?: boolean;
