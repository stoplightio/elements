...
export const TryItResponse: React.FC<React.PropsWithChildren<{ response: ResponseState }>> = ({ response }) => {
...
export const ResponseError: React.FC<React.PropsWithChildren<{ state: ErrorState }>> = ({ state: { error } }) => (
  <Panel defaultIsOpen>
