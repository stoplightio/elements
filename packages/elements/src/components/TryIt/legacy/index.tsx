...
const OldTryItComponent = React.memo<ITryItProps>(
...
OldTryItComponent.displayName = 'TryIt.Component';

export const OldTryIt = withErrorBoundary<ITryItProps>(OldTryItComponent, { recoverableProps: ['nodeData'] });
