...
export function useRequestMaker(value: IHttpOperation | IHttpRequest, checkCache?: boolean): RequestMakerStore {
...
function getCachedRequestMaker({ operation, request }: { operation?: IHttpOperation; request?: IHttpRequest }) {
