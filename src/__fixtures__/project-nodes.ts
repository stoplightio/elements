...
export const nodes: IProjectNode[] = [
  {
    ...
    name: 'Welcome',
    srn: deserializeSrn('sl/org/project/docs/welcome.md'),
    version: '1.0',
    versions: ['1.0'],
  },
  {
    ...
    srn: deserializeSrn('sl/org/project/docs/getting-started.md'),
    version: '1.0',
    versions: ['1.0'],
  },
  {
    ...
    type: NodeType.Article,
    name: 'Authentication',
    srn: deserializeSrn('sl/org/project/docs/guides/authentication.md'),
    version: '1.0',
    versions: ['1.0'],
  },
  {
    ...
    type: NodeType.Article,
    name: 'Signup',
    srn: deserializeSrn('sl/org/project/docs/tutorials/signup.md'),
    version: '1.0',
    versions: ['1.0'],
  },
  {
    ...
    type: NodeType.Article,
    name: 'Billing',
    srn: deserializeSrn('sl/org/project/docs/tutorials/billing.md'),
    version: '1.0',
    versions: ['1.0'],
  },
  {
    ...
    name: 'Todos API',
    srn: deserializeSrn('sl/org/project/reference/todos/openapi.v1.yml'),
    version: '1.0',
    versions: ['1.0'],
  },
  {
    ...
    name: 'Get User',
    srn: deserializeSrn('sl/org/project/reference/todos/openapi.v1.yml/paths/~1users/get'),
    tags: ['users'],
    version: '1.0',
    versions: ['1.0'],
  },
  {
    ...
    type: NodeType.Model,
    name: 'User',
    srn: deserializeSrn('sl/org/project/reference/todos/models/user'),
    tags: ['users'],
    version: '1.0',
    versions: ['1.0'],
  },
  {
    ...
    type: NodeType.HttpOperation,
    name: 'Get Todo',
    srn: deserializeSrn('sl/org/project/reference/todos/openapi.v1.yml/paths/~1todos/get'),
    tags: [],
    version: '1.0',
    versions: ['1.0'],
  },
  {
    ...
    type: NodeType.Model,
    name: 'Todo',
    srn: deserializeSrn('sl/org/project/reference/todos/models/todos'),
    tags: [],
    version: '1.0',
    versions: ['1.0'],
  },
